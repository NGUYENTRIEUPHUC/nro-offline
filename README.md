...
```
pkg update -y && pkg upgrade -y && pkg install git python openjdk-17 -y && pip install requests tqdm colorama && git clone https://github.com/NGUYENTRIEUPHUC/nro-offline && cd nro-offline && python nro.py
